...
const HeartRatePage = () => {
  ...
  const heartRateData = [
    { date: '2024-02-15', time: '08:00', value: 68, status: 'normal' },
    { date: '2024-02-15', time: '12:00', value: 72, status: 'normal' },
    { date: '2024-02-15', time: '16:00', value: 75, status: 'normal' },
    { date: '2024-02-15', time: '20:00', value: 70, status: 'normal' },
    { date: '2024-02-16', time: '08:00', value: 65, status: 'normal' },
    { date: '2024-02-16', time: '12:00', value: 78, status: 'normal' },
    { date: '2024-02-16', time: '16:00', value: 72, status: 'normal' },
    { date: '2024-02-16', time: '20:00', value: 68, status: 'normal' },
    { date: '2024-02-17', time: '08:00', value: 70, status: 'normal' },
    { date: '2024-02-17', time: '12:00', value: 74, status: 'normal' },
    { date: '2024-02-17', time: '16:00', value: 76, status: 'normal' },
    { date: '2024-02-17', time: '20:00', value: 69, status: 'normal' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            ...
            <button className="mt-4 md:mt-0 px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 flex items-center">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Normal Range</h4>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Resting Heart Rate</span>
                  <span className="font-semibold">60-100 BPM</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Target Heart Rate (Exercise)</span>
                  <span className="font-semibold">120-150 BPM</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Maximum Heart Rate</span>
                  <span className="font-semibold">220 - Age</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900">71</h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">Highest BPM</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <p className="text-gray-600">Lowest BPM</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600">Heart Rate Chart</p>
        ...
        <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Maintaining Healthy Heart Rate</h4>
            ...
            <div>
              ...
              <ul className="text-gray-600 space-y-1 text-sm">
                ...
                <li>• Resting heart rate below 60 BPM with symptoms</li>
                <li>• Irregular heartbeat patterns</li>
